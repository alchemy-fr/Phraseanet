...
namespace Alchemy\Phrasea\RouteProcessor\Prod;
...
class Root extends RouteProcessor\RouteAbstract
{
  ...
  protected function get()
  {
    ...
    $css = array();
    $cssfile = false;
    $registry = $this->getKernel()->getRegistry();
    ...
    $out = $twig->render('prod/index.html', array(
        ...
        'WorkZone' => new Helper\WorkZone($this->getKernel()),
        'module_prod' => $this->getRequestHelper(),
        'cssfile' => $cssfile,
        'module' => 'prod',
