...
class Language implements ControllerProviderInterface
{
    ...
    public function getTranslationsAction(Application $app) {
        $out = [];
        ...
        $out['confirmRemoveReg'] = $app->trans(
        ...
        $out['some_not_published'] = $app->trans(
        ...
        $out['warning_delete_publi'] = $app->trans(
        ...
        $out['some_required_fields'] = $app->trans(
