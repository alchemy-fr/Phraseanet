 ...
 * @ExclusionPolicy("all")
 */
class ContainerFormatName extends AbstractTag
{

    protected $Id = 'ContainerFormatName';

    protected $Name = 'ContainerFormatName';
    ...
    protected $Description = 'Container Format Name';
