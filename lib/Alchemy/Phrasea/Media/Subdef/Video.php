...
class Video extends Audio
{
    ...
    public function __construct(TranslatorInterface $translator)
    {
        ...
        $this->registerOption(new OptionType\Enum($this->translator->trans('Audio Codec'), self::OPTION_ACODEC, ['libfdk_aac', 'libvo_aacenc', 'libmp3lame', 'libvorbis','libfaac'], 'libfdk_aac'));
    }
