...
class ApplicationAppCommand extends Command
{
    ...
    public function __construct($name = null)
    {
        ...
        $this->setDescription('Create, edit, delete application in Phraseanet <comment>(experimental)</>')
            ...
            ->addOption('webhook_url', null, InputOption::VALUE_REQUIRED, 'Define a webhook url on edit')
            ->addOption('create_token', null, InputOption::VALUE_NONE, 'Generate an access token when app is created')
            ->addOption('activate_password', null, InputOption::VALUE_OPTIONAL, 'Activate password OAuth2 grant type , values true or false', 'false')
