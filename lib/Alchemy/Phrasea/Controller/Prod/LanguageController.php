...
class LanguageController
{
    ...
    public function getTranslationsAction()
    {
        ...
        return new JsonResponse([
            ...
            'removeRecordFeedbackTitle' => $translator->trans('basket:Delete one record'),
            ...
            'confirmRemoveFeedBack'   => $translator->trans('basket::Warning!You are about to delete one record from a feedback, please confirm your action'),
            'movedRecord'             => $translator->trans('basket::Documents are being to moved !'),
