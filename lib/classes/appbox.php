...
class appbox
{
    ...
    public function setVersion(PhraseaVersion $version)
    {
    ...
    private function retrieve_sbas_ids()
    {
        try {
    ...
    private function post_upgrade(Application $app)
    {
    ...
    private function upgradeDb($apply_patches, Application $app)
    {
        $recommends = [];
        ...
        foreach ($rs as $row) {
            ...
            if (isset($allTables[$tname])) {
                ...
                $recommends[] = [
                    ...
                    'sql'     => 'DROP TABLE ' . $this->connection->getDatabase() . '.`' . $tname . '`;'
                ];
            }
        }
    ...
    private function createTable(SimpleXMLElement $table)
    {
    ...
    private function upgradeTable(SimpleXMLElement $table)
    {
    ...
    private function apply_patches($from, $to, $post_process, Application $app)
    {
