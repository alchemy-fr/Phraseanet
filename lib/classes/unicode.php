...
class unicode
{
    ...
    public function remove_nonazAZ09($string, $keep_underscores = true, $keep_minus = true, $keep_dot = false, $keep_space = false, $keep_plus = false)
    {
        ...
        for ($i = 0; $i < $l; $i ++) {
            ...
            if(($c>='a'&&$c<='z')||($c>='A'&&$c<='Z')||($c>='0'&&$c<='9')
                ||($keep_underscores&&$c=='_')||($keep_dot&&$c=='.')||($keep_minus&&$c=='-')||($keep_space&&$c==' ')||($keep_plus&&$c=='+')) {
                $out .= $c;
            }
        }
