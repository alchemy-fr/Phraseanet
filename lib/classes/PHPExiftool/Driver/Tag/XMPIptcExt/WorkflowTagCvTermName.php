 ...
 * @ExclusionPolicy("all")
 */
class WorkflowTagCvTermName extends AbstractTag
{

    protected $Id = 'WorkflowTagCvTermName';

    protected $Name = 'WorkflowTagCvTermName';
    ...
    protected $Description = 'Workflow Tag Cv Term Name';
