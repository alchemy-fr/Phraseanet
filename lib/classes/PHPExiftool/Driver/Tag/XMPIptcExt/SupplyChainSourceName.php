 ...
 * @ExclusionPolicy("all")
 */
class SupplyChainSourceName extends AbstractTag
{

    protected $Id = 'SupplyChainSourceName';

    protected $Name = 'SupplyChainSourceName';
    ...
    protected $Description = 'Supply Chain Source Name';
