 ...
 * @ExclusionPolicy("all")
 */
class DataOnScreenRegion extends AbstractTag
{

    protected $Id = 'DataOnScreenRegion';

    protected $Name = 'DataOnScreenRegion';
    ...
    protected $Description = 'Data On Screen Region';
