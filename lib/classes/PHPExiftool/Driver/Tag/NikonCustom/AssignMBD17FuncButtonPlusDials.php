 ...
 * @ExclusionPolicy("all")
 */
class AssignMBD17FuncButtonPlusDials extends AbstractTag
{

    protected $Id = '68.1';

    protected $Name = 'AssignMB-D17FuncButtonPlusDials';

    protected $FullName = 'NikonCustom::SettingsD500';
    ...
    protected $Description = 'Assign MB-D17 Func Button Plus Dials';
