 ...
 * @ExclusionPolicy("all")
 */
class AITargetResolution extends AbstractTag
{

    protected $Id = 'AI5_TargetResolution';

    protected $Name = 'AITargetResolution';
    ...
    protected $Description = 'AI Target Resolution';
