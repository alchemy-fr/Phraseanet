    ...
    public static function getTechnicalFieldsList()
    {
        if (empty(self::$technicalFieldsList)) {
            self::$technicalFieldsList = [
              self::TC_DATA_WIDTH              => ['method' => 'getWidth', 'type' => 'integer'],
              self::TC_DATA_HEIGHT             => ['method' => 'getHeight', 'type' => 'integer'],
              self::TC_DATA_FOCALLENGTH        => ['method' => 'getFocalLength', 'type' => 'float'],
              self::TC_DATA_CHANNELS           => ['method' => 'getChannels', 'type' => 'integer'],
              self::TC_DATA_COLORDEPTH         => ['method' => 'getColorDepth', 'type' => 'integer'],
              self::TC_DATA_CAMERAMODEL        => ['method' => 'getCameraModel', 'type' => 'keyword'],
              self::TC_DATA_FLASHFIRED         => ['method' => 'getFlashFired', 'type' => 'boolean'],
              self::TC_DATA_APERTURE           => ['method' => 'getAperture', 'type' => 'float'],
              self::TC_DATA_SHUTTERSPEED       => ['method' => 'getShutterSpeed', 'type' => 'float'],
              self::TC_DATA_HYPERFOCALDISTANCE => ['method' => 'getHyperfocalDistance', 'type' => 'float'],
              self::TC_DATA_ISO                => ['method' => 'getISO', 'type' => 'integer'],
              self::TC_DATA_LIGHTVALUE         => ['method' => 'getLightValue', 'type' => 'float'],
              self::TC_DATA_COLORSPACE         => ['method' => 'getColorSpace', 'type' => 'integer'],
              self::TC_DATA_DURATION           => ['method' => 'getDuration', 'type' => 'float'],
              self::TC_DATA_FRAMERATE          => ['method' => 'getFrameRate', 'type' => 'float'],
              self::TC_DATA_AUDIOSAMPLERATE    => ['method' => 'getAudioSampleRate', 'type' => 'float'],
              self::TC_DATA_VIDEOCODEC         => ['method' => 'getVideoCodec', 'type' => 'keyword'],
              self::TC_DATA_AUDIOCODEC         => ['method' => 'getAudioCodec', 'type' => 'keyword'],
              self::TC_DATA_ORIENTATION        => ['method' => 'getOrientation', 'type' => 'integer'],
              self::TC_DATA_LONGITUDE          => ['method' => 'getLongitude', 'type' => 'float'],
              self::TC_DATA_LONGITUDE_REF      => ['method' => 'getLongitudeRef'],
              self::TC_DATA_LATITUDE           => ['method' => 'getLatitude', 'type' => 'float'],
              self::TC_DATA_LATITUDE_REF       => ['method' => 'getLatitudeRef'],
              self::TC_DATA_MIMETYPE           => ['type' => 'keyword'],
              self::TC_DATA_FILESIZE           => ['type' => 'long'],
            ];
        }
