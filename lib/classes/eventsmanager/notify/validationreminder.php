...
class eventsmanager_notify_validationreminder extends eventsmanager_notifyAbstract
{
    ...
    public function datas($datas, $unread)
    {
        ...
        $ret = [
            'text'  => $this->app->trans('Rappel : Il vous reste %number% jours pour valider %title% de %user%', array('%number%' => $this->app['phraseanet.registry']->get('GV_validation_reminder'), '%title%' => $bask_link, '%user%' => $sender))
