 ...
 */
class BasketElementVote extends \Alchemy\Phrasea\Model\Entities\BasketElementVote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'id', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'agreement', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'note', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'updated', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'participant', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\BasketElementVote' . "\0" . 'basket_element'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BasketElementVote $proxy) {
