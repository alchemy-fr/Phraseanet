 ...
 */
class WorkerJob extends \Alchemy\Phrasea\Model\Entities\WorkerJob implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'id', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'type', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'data', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'status', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'created', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'started', '' . "\0" . 'Alchemy\\Phrasea\\Model\\Entities\\WorkerJob' . "\0" . 'finished'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkerJob $proxy) {
