 ...
 * })
 * @ORM\Entity(repositoryClass="App\Repository\ApiAccountRepository")
 */
class ApiAccount
{
    /**
    ...
    /**
     * @return Collection|ApiOauthToken[]
     */
    ...
    public function addToken(ApiOauthToken $token): self
    {
    ...
    public function removeToken(ApiOauthToken $token): self
    {
        if ($this->tokens->contains($token)) {
