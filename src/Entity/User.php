...
class User
{
    ...
    public function getSaltedPassword(): ?bool
    {
        return $this->saltedPassword;
    }
    ...
    public function getMailNotificationsActivated(): ?bool
    {
        return $this->mailNotificationsActivated;
    }

    public function getRequestNotificationsActivated(): ?bool
    {
        return $this->requestNotificationsActivated;
    }

    public function getLdapCreated(): ?bool
    {
        return $this->ldapCreated;
    }

    public function getCanChangeProfil(): ?bool
    {
        return $this->canChangeProfil;
    }

    public function getCanChangeFtpProfil(): ?bool
    {
        return $this->canChangeFtpProfil;
    }

    public function getMailLocked(): ?bool
    {
        return $this->mailLocked;
    }
    ...
    public function removeQuery(UserQuery $query): self
    {
        if ($this->queries->contains($query)) {
            $this->queries->removeElement($query);
            // set the owning side to null (unless already changed)
            if ($query->getUser() === $this) {
                $query->setUser(null);
            }
        }
    ...
    public function addNotificationSetting(UserNotificationSetting $notificationSetting): self
    {
    ...
    public function removeNotificationSetting(UserNotificationSetting $notificationSetting): self
    {
        if ($this->notificationSettings->contains($notificationSetting)) {
