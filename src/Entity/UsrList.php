 ...
 * @ORM\Entity(repositoryClass="App\Repository\UsrListRepository")
 */
class UsrList
{
    /**
    ...
    public function addEntry(UsrListEntry $entry): self
    {
    ...
    public function removeEntry(UsrListEntry $entry): self
    {
        if ($this->entries->contains($entry)) {
