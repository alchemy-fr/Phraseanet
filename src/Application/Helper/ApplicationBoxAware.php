...
trait ApplicationBoxAware
{
    ...
    /**
     * @return \App\Utils\appbox
     */
    public function getApplicationBox()
    {
        if ($this->applicationBox instanceof \App\Utils\appbox) {
        ...
        if (!$instance instanceof \App\Utils\appbox) {
