...
class AccessRestriction
{
    ...
    public function __construct(PropertyAccess $propertyAccess, \App\Utils\appbox $appbox, LoggerInterface $logger)
    {
     ...
     * @return bool
     */
    public function isDataboxAvailable(\App\Utils\databox $databox)
    {
    ...
    {
        Assertion::allIsInstanceOf($databoxes, \App\Utils\databox::class);
        ...
        return array_filter($databoxes, function (\App\Utils\databox $databox) use ($available) {
