...
--
-- Host: localhost    Database: {{APPLICATION_BOX}}31
-- ------------------------------------------------------
...
--
-- Current Database: `{{APPLICATION_BOX}}`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `{{APPLICATION_BOX}}` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `sbas` VALUES (1,1,'127.0.0.1',3306,'{{DATA_BOX}}','MYSQL','root','',0,'',1);
