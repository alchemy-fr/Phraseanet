...
FROM alchemyfr/phraseanet-base:1.0.1-alpha3 AS builder
...
FROM alchemyfr/phraseanet-base:1.0.1-alpha3 AS phraseanet-setup
...
FROM alchemyfr/phraseanet-base:1.0.1-alpha3 AS phraseanet-fpm
...
FROM alchemyfr/phraseanet-base:1.0.1-alpha3 AS phraseanet-worker
...
FROM alchemyfr/phraseanet-base:1.0.1-alpha3 AS phraseanet-saml-sp
RUN apt-get update \
    && apt-get install -y \
        apt-transport-https \
        ca-certificates \
