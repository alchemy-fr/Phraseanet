...
class QueryContextTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $foo_field = new Field('foo', FieldMapping::TYPE_TEXT, ['private' => false]);
        $bar_field = new Field('bar', FieldMapping::TYPE_TEXT, ['private' => false]);
    ...
    {
        $foo_field = new Field('foo', FieldMapping::TYPE_TEXT, ['private' => true]);
        $bar_field = new Field('bar', FieldMapping::TYPE_TEXT, ['private' => true]);
        $structure = $this->prophesize(Structure::class);
